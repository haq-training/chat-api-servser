...
export type chat_membersCreationAttributes = Optional<
    ...
    chat_membersOptionalAttributes
>;

export class chat_members
    extends Model<chat_membersAttributes, chat_membersCreationAttributes>
    implements chat_membersAttributes
{
    id!: number;
    ...
    setChatRoom!: Sequelize.BelongsToSetAssociationMixin<
        chat_room,
        chat_roomId
    >;
